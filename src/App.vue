      ...
      <va-card>
        <va-card-content>
          ...
          <div class="px-4 mt-4 flex justify-center items-center flex-col" >
            <va-button preset="secondary" icon="add" @click="doShowAddModal = true">Saat qurşağı əlavə edin</va-button>
            <p class="va-text flex items-center" v-if="timeZones.length > 0">
              <va-icon name="lightbulb" size="small" color="warning" class="mr-2" />
             💡 ipucu: Vaxtı dəyişmək üçün yuxarıdakı slayderdən istifadə edin
            </p>
          </div>
        </va-card-content>
      </va-card>
