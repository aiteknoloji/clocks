<template>
  <va-modal :model-value="modelValue" @ok="onOk" @cancel="onCancel" @before-open="onBeforeOpen" title="Saat qurşağı əlavə edin" no-outside-dismiss>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const textBy = (timeZone: TimeZone) => {
      ...
      if (name.includes('Baku')) {
        name = name.replace('Baku', 'Baku 🇦🇿')
      }
